...
class IsSeasonal extends ConsumerStatefulWidget {
  const IsSeasonal({super.key});

  @override
  _IsSeasonalState createState() => _IsSeasonalState();
}

class _IsSeasonalState extends ConsumerState<IsSeasonal> {
