...
class IsNewLaunch extends ConsumerStatefulWidget {
  const IsNewLaunch({super.key});

  @override
  _IsNewLaunchState createState() => _IsNewLaunchState();
}

class _IsNewLaunchState extends ConsumerState<IsNewLaunch> {
