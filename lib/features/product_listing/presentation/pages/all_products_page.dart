...
class ProductsWithUnitsPage extends ConsumerStatefulWidget {
  const ProductsWithUnitsPage({super.key});

  @override
  _ProductsWithUnitsPageState createState() => _ProductsWithUnitsPageState();
}

class _ProductsWithUnitsPageState extends ConsumerState<ProductsWithUnitsPage> {
  @override
  ...
  void initState() {
    ...
    Future.microtask(() {
      ref.read(productViewModelProvider.notifier).fetchProductsWithUnits(
            Constants.productsWithUnitsListAllProducts,
          );
    });
  }
