...
// import 'package:onlinedukans_user/providers/cart_provider.dart'; // Import the updated cartProvider
  ...
  void initState() {
    ...
    Future.microtask(() {
      ref.read(productViewModelProvider.notifier).fetchProductsWithUnits(
            '${Constants.productsWithUnitsByCategory}/${widget.categoryId}',
          );

      // Fetch cart details on initialization
